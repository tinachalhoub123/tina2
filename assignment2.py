...
st.info('We can see that the mortality rate is extremely high in 1976 and lower but still high in 1982 and this is due to the Civil war, the assassination of president Bachir Gemayel and the Sabra and Shatila Massacre. After this we see that the death rate decreases until 2020 where the covid-19 pandemic started and the death rate reincreases.')
# Add interactive controls
